...
while {alive player} do
{
	...
	if ((cursortarget iskindof "man") && (isplayer cursortarget)) then {
		...
		if((license_civ_rebel)&& (player distance cursortarget < 4) && (/*(cursortarget getVariable "AGM_isUnconscious") || */((cursortarget getVariable "isknocked")) || ((cursortarget getVariable "restrained")) || ((cursortarget getVariable "playerSurrender")))) then {
