...
hint parseText "<t size='1.1px'>Sauvegarde du joueur dans la base de données.<br/>Attendez minimum 20 secondes.<br/><br/><t color='#FF0000' size='1.3px' align='center'>/!\ATTENTION/!\</t><br/><t size='1.3px'>L'argent liquide ne se sauvegarde pas après votre déconnection";
[] spawn
{
