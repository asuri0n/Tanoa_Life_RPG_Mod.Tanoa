...
if(_class == "") exitWith {diag_log "INVO DEBUG - fetchVehInfo bad class passed"; [];}; //Bad class passed.
if(!isClass (configFile >> "CfgVehicles" >> _class)) exitWith {diag_log "INVO DEBUG - fetchVehInfo class doesn't exist"; [];}; //Class doesn't exist in CfgVehicles
