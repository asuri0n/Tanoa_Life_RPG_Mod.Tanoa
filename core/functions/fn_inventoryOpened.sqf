...
if (((playerSide == civilian) && (license_civ_rebel)) && (cursortarget getVariable "FAR_isUnconscious")or (cursortarget getVariable "restrained") or (group cursortarget == group player) or (cursortarget getVariable "playerSurrender")) then {
