...
switch (typeOf _vehicle) do
{
    ...
    case "C_Hatchback_01_F":{_lightright lightAttachObject [_vehicle, [0.6, 2, -0.95]];};//<-------ajout hayon
	case "C_Hatchback_01_sport_F":{_lightright lightAttachObject [_vehicle, [0.6, 2, -0.95]];};//<-------ajout hayon sport
	case "B_MRAP_01_F":{_lightright lightAttachObject [_vehicle, [1, -2.8, 0.55]];};//<------ajout hunter
	case "I_MRAP_03_F":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};//<-----ajout strider
	case "I_MRAP_03_hmg_F":{_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};//<-----ajout strider hmg
	case "B_Heli_Light_01_F": {_lightright lightAttachObject [_vehicle, [0.37, 0.0, 0.56]];};//<----ajout lillte bird
};
