...
if(_building in invo_bank_buildings) then {
	[[[1,2],"!!!!! QUELQU'UN TENTE DE S'INTRODUIRE DANS LA RÈSERVE FÈDÈRALE !!!!!!",true,[]],"life_fnc_broadcast",true,false] call life_fnc_MP;
} else {
...
_title = localize "Crochetage de la serrure";
