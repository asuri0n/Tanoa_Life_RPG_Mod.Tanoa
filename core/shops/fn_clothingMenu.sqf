...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","kart","donator"] && (playerSide != civilian && playerSide != east)) exitWith {hint "Tu dois être un civil pour utiliser ce vendeur!"; closeDialog 0;};
if((_this select 3) in ["reb"] && !license_civ_rebel) exitWith {hint "Tu dois être rebelle pour utiliser ce vendeur!"; closeDialog 0;};
