...
"Prix location: <t color='#8cff9b'>$%1</t><br/>Prix achat: <t color='#8cff9b'>$%2</t><br/>Vitesse max: %3 km/h<br/>Nombre CV: %4<br/>Sieges passagers: %5<br/>Coffre: %6<br/>Reservoir: %7<br/>Blindage: %8",
