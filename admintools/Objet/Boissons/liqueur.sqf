...
////////////////////////////////////
			...
			_ColCor ppEffectAdjust [1, 0.75, 0, [0.8,0.9,1,-0.1], [1,1,1,2], [-0.5,0,-1,5]]; 
			...
			_RadBlu ppEffectAdjust [0.02,0.02,0.15,0.15]; 
			_RadBlu ppEffectCommit 30;	
			
			addCamShake [75, 800, 0.4];	
	
			addCamShake [62, 600, 0.3];	
			sleep (5); 					
			addCamShake [23, 600, 0.2];			