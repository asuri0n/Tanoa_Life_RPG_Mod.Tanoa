class SettingsMenu
{
	...
	class controlsBackground
	{
		...
		class IntroHeader : PlayerTagsHeader
		{
			idc = -1;
			text = "Intro Vacation Gaming ?";
			
			y = 0.58;
		};
		
		class SoundHeader : PlayerTagsHeader
		{
			idc = -1;
			text = "Régler la baisse de son pour les véhicules:";
	...
	class controls
	{
		...
		{
			idc = 2973;
			tooltip = "Désactive ou active l'intro Vacation Gaming. Sauvegardé dans vos options!";
			action = "[] call life_fnc_introOnOff;";
			y = 0.58;
		};

		class VDsoundCarText : life_RscText
		{
			idc = -1;
			text = "Sol:";
		...
		class VDsoundCarSlider : life_RscXSliderH 
		{
			idc = 2931;
			text = "";
			onSliderPosChanged = "[3,_this select 1] call life_fnc_s_onSliderChange;";
			tooltip = "Permet de régler la baisse de son lorsque vous montez dans ce type de véhicule. 100 = son complètement baissé, 0 = son à l'identique.";
			x = 0.42;
			y = 0.7;
		...
		class VDsoundCarValue : life_RscText
		{
			idc = 2932;
			text = "";
		...
		class VDsoundAirText : life_RscText
		{
			idc = -1;
			text = "Air:";
		...
		class VDsoundAirSlider : life_RscXSliderH 
		{
			idc = 2941;
			text = "";
		...
		class VDsoundAirValue : life_RscText
		{
			idc = 2942;
			text = "";
		...
		class VDsoundSeaText : life_RscText
		{
			idc = -1;
			text = "Mer:";
		...
		class VDsoundSeaSlider : life_RscXSliderH 
		{
			idc = 2951;
			text = "";
		...
		class VDsoundSeaValue : life_RscText
		{
			idc = 2952;
			text = "";
