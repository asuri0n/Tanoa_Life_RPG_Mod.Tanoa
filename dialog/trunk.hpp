class TrunkMenu
{
	...
	class controlsBackground
	{
		...
		Replacing this title by a combo that will be filled in with all vehicle within a certain range. Selecting something else thant "Inventory" should launch a process transfering selected objects.
		*/
	};
	...
	class Controls
	{
		class TrunkGear : Life_RscListBox
		{
			...
			text = "";
			sizeEx = 0.030;
			onLBSelChanged = "[] call life_fnc_vehInventory;";
		...
		class ButtonClose : Life_RscButtonMenu {
			...
			onButtonClick = "[] call life_fnc_vehInventoryClose;";
			x = 0.1;
			y = 0.9 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
